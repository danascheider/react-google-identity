...
function runGapiScript() {
  ...
  */
    ...
    var Ia = function (a) {
        if (a instanceof x && a.constructor === x && a.ea === Ha) return a.S
  ...
  gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var Hc =
      ...
      Jc = function () {
        ...
        null == a &&
          ...
          (a = J(b, 'authuser') || null),
          null == a && (a = (a = b.match(Hc)) ? a[1] : null))
    ...
    var Fd = {
      ...
      Jd = function (a, b, c, d, e) {
        ...
        try {
          ...
          f ||
            ((f = (a ? new Va(Ua(a)) : va || (va = new Va())).ha('IFRAME')),
            g &&
              ((f.onload = function () {
                f.onload = null
                g.call(this)
        ...
        switch (te(b, a, f)) {
          ...
          case 1:
            if (b.parentNode) {
              ...
              g = b = h
              Kd.test(b) &&
                ((g = S('iframes/' + g.substring(1) + '/url')),
                G(!!g, 'Unknown iframe url config for - ' + b))
              h = tb(B, g.replace(Ld, Nd))
              b = c.ownerDocument || B
              g = f
              var l = 0
              do k = g.id || ['I', Hd++, '_', new Date().getTime()].join('')
    ...
    function Ke(a) {
      ...
      return (!d && ('U' !== c || e.l)) || (d && !Ge)
        ? b
        : { X: !0, l: d, na: a.substr(1), domain: e.domain, o: e.o }
    }
    var Le = function (a) {
        if (!a) return []
        a = a.split('=')
    ...
    window.gapi.load('', {
      ...
      _c: {
        ...
        jsl: {
          ...
          h: 'm;/_/scs/abc-static/_/js/k=gapi.lb.en.dzXZWX9QTbE.O/d=1/rs=AHpOoo_epIQDPHdjFr3MLkazUi2Jmy50dQ/m=__features__',
